...
<script>
	...
	$.extend( $.fn.dataTable.defaults, {
            ...
            'pdf'],
            language: {
                search: '<span>Cari File :</span> _INPUT_',
                searchPlaceholder: 'Judul File ...',
	...
	$('#datatable-upload tbody').on( 'click', '#edit', function () {
        var data = table.row( $(this).parents('tr') ).data();
		window.location.href = BaseUrl+"/admin/file/"+data['id']+"/edit";
    } );
	...
	function add(){
		window.location.href = BaseUrl+"/admin/file/create"; 
	}
	

	function open(id){
	          swal({
                title: 'Anda yakin ingin membuka file ini?',
