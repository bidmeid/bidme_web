...
(function ($) {
  ...
  "use strict";
    ...
    $(window).on('load',function() {
        if($('#sekretariat').hasClass('active')) {
            $( '.gallery-img-box:not([data-category-image*=sekretariat]').addClass("gallery-hidden");
            $( '.gallery-img-box[data-category-image*=sekretariat]').removeClass("gallery-hidden");
        }
    });
